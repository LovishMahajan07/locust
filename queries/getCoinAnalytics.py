...
# locust -f getCoinAnalytics.py -u 10000 -r 100 -t 1m --headless
...
class MyReqRes(HttpUser):
    ...
    def get(self):
        query="""
            query getCoinAnalytics($type:String,$network:String,$skip:Int,$limit:Int) { 
                getCoinAnalytics(type: $type,network: $network,skip: $skip,limit: $limit){ 
                    success 
                    message 
                    data
                }
