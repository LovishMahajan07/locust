...
# locust -f getTwitterFeed.py -u 10000 -r 1 -t 1m --headless
...
class MyReqRes(HttpUser):
    ...
    def get(self):
        query="""
            query getTwitterFeed ($queryString: String!, $token: String!) {
                getTwitterFeed (queryString: $queryString, token: $token) {
                    success
                    message
                    data
                }
