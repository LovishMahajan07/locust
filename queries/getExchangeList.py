...
# locust -f getExchangesList.py -u 10000 -r 1 -t 1m --headless
...
class MyReqRes(HttpUser):
    ...
    def get(self):
        query="""
            query getExchangesList ($region: String) {
                getExchangesList (region: $region) {
                    success
                    message
                    data
                }
        ...
        response=self.client.post(
            ...
            json={"query":query,"variables":{"region":"Europe"}}
        )
