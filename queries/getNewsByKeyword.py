...
# locust -f getNewsByKeyword.py -u 10000 -r 1 -t 1m --headless
...
class MyReqRes(HttpUser):
    ...
    def get(self):
        query="""
            query getNewsByKeyword ($keyword: String!, $limit: String,$skip: String) {
                getNewsByKeyword (keyword: $keyword, limit: $limit,skip: $skip) {
                    success
                    message
                    data
                }
