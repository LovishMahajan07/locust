...
# locust -f getOtherUserProfile.py -u 10000 -r 1 -t 1m --headless
...
class MyReqRes(HttpUser):
    ...
    def get(self):
        query="""
            query getOtherUserProfile($otherUserId:String!) {
                getOtherUserProfile(otherUserId:$otherUserId) {
                    success
                    message
                    data
                }
    ...
    "otherUserId":"61c213e2b9ae62ad5e61ed24"
}}
        )
