...
# locust -f getJoinedCommunityNews.py -u 10000 -r 100 -t 1m --headless
...
class MyReqRes(HttpUser):
    ...
    def get(self):
        query="""
            query getJoinedCommunityNews ($limit: Int,$skip: Int) {
                getJoinedCommunityNews (limit: $limit,skip: $skip) {
                    success
                    message
                    data
                }
