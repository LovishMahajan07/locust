...
# locust -f getAnnouncements.py -u 10000 -r 100 -t 1m --headless
...
class MyReqRes(HttpUser):
    ...
    def get(self):
        query="""
            query getAnnouncements ($communityId: String) {
                getAnnouncements (communityId: $communityId) {
                    success
                    message
                    data
                }
  ...
  "communityId":"61f01e45192a5a6570cc1ffe"
}}
        )
