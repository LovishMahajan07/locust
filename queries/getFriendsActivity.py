...
# locust -f getFriendsActivity.py -u 10000 -r 100 -t 1m --headless
...
class MyReqRes(HttpUser):
    ...
    def get(self):
        query="""
            query getFriendsActivity($sort: Int,$limit: Int) {
                getFriendsActivity(sort:$sort, limit:$limit) {
                    success
                    message
                    data
                }
        ...
        response=self.client.post(
            ...
            json={"query":query,"variables":{"sort":-1,"limit":4}}
        )
